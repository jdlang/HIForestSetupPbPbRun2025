...
# Collisions: 2025 PbPb Zero Bias, Prompt Reco
# Input: miniAOD
# Type: data
...
INPUT_TEST_FILE = "/store/hidata/HIRun2025A/HIZeroBias0/MINIAOD/PromptReco-v1/000/399/003/00000/cf58d0cb-e872-4672-aa6a-48dd713fa595.root"
INPUT_MAX_EVENTS    = 1000
OUTPUT_FILE_NAME    = "HiForest_2025PbPbZeroBias_PromptReco.root"
...
if INCLUDE_HLTFILTER :
    ...
    process.filterSequence = cms.Sequence(
        process.hltfilter *
        (process.zdcrecoRun3 + process.zdcEnergyFilter0nAnd)
    )
